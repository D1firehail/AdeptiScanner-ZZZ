(This description was written for the Genshin version of the scanner, but it's mostly valid for the ZZZ version too. Dedicated instructions will be provided at a later time)
# AdeptiScanner-GI
